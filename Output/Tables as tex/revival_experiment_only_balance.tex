\begin{table}[htbp!] \caption{ Balance amongst randomly assigned revival participants } \label{ revival_experiment_only_balance } % latex table generated in R 3.6.1 by xtable 1.8-4 package
