\begin{table}[htbp!] \label{ revival_covariates } \caption{ Comparing demographic variables and religious behaviour across participants who took part in regular and revival weeks } % latex table generated in R 3.6.1 by xtable 1.8-4 package
