\begin{table}[htbp!] \caption{ Mean values of additional demographic variables that were not pre-registered } \label{ other_covariates } % latex table generated in R 3.6.1 by xtable 1.8-4 package
